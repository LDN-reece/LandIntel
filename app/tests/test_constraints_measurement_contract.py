...
class ConstraintsMeasurementContractTests(unittest.TestCase):
    ...
    def test_priority_zero_engine_is_material_change_and_geometry_mode_aware(self) -> None:
        for snippet in (
            ...
            "constraint_scan_state_row_count",
            "canonical_sites_with_constraint_scan_state",
            "missing_overlap_character_count",
            "measured_constraint_source_family_count",
            "sepa_flood_source_feature_count",
            "sepa_flood_measurement_count",
            "scanned_site_layer_pair_pct",
            "landintel_flood_records_source_uidx",
