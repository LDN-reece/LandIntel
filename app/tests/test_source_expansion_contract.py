...
class SourceExpansionContractTests(unittest.TestCase):
    ...
    def test_os_sources_are_registered_and_bulk_landing_is_bounded(self) -> None:
        ...
        self.assertIn("OPEN_LOCATION_SPINE_CONTEXT_REFRESH_MODE", RUNNER)
        self.assertIn("OPEN_LOCATION_SPINE_CONTEXT_REFRESH_MODE", WORKFLOW)
        self.assertIn("deferred_after_light_mode_failure", RUNNER)
